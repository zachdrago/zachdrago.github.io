...
// jQuery.trumbowyg.svgPath = '//cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.6.0/ui/icons.svg';
...
jQuery.trumbowyg = {
    ...
    // SVG Path globally
    svgPath: '//cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.6.0/ui/icons.svg',
    ...
    var Trumbowyg = function (editorElem, options) {
        ...
        if ($('#' + trumbowygIconsId, t.doc).length === 0 && svgPathOption !== false) {
            ...
            $.ajax({
                ...
                dataType: 'xml',
                crossDomain : true,
                url: '//raw.githubusercontent.com/zachdrago/zachdrago.github.io/master/icons.svg',
                data: null,
                beforeSend: null,
                complete: null,
